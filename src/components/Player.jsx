...
const Player = ({ duration, randomIdFromArtist, randomIdFromArtist2, audio }) => {
    ...
    const [currentTime, setCurrentTime ] = useState(formatTime (2, "0"))
    const durationInSecond = timeInSeconds(duration)
    ...
    useEffect(() => {
       const intervalId = setInterval(() => {
        ...
        ((audioPlayer.current.currentTime / durationInSecond * 100) + "%"))
